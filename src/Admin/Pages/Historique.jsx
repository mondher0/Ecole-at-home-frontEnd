...
const Historique = () => {
  ...
  const getLogs = async () => {
    try {
      const response = await axiosInstance.get(
        `${baseURl}/log/admin/search?page=1&pageSize=5`
      );
  ...
  return (
    <div className="admin_section abonnements">
      ...
      <div className="admin_sections_header">
        <h2 className="admin_section_title sub">Aujourd’hui</h2>
      ...
      <div className="history_list">
        <div className="history_item">
          ...
          <p>Admin Imane Akkal a bloqué Nicholas Patrick</p>
      ...
      <div className="admin_sections_header">
        <h2 className="admin_section_title sub">18 Janvier 2022</h2>
      </div>
