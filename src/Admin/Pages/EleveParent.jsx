    ...
    <div className='admin_section'>
        <div className='admin_sections_header'>
            <h2 className='admin_section_title tabs'>
                <span className={tab === "Eleve" ? "active" : ""} 
                onClick={()=>setTab("Eleve")}>Elèves</span>
                <span className={tab === "Parent" ? "active" : ""} 
                onClick={()=>setTab("Parent")}>Parents</span>
            </h2>
        ...
        <div className="table-responsive">
            <table className="table table-striped table-bordered">
                ...
                {data.map((row) => (
                    <tr key={row.id}>
                    <td onClick={()=>Navigate(`/admin/${tab}/edit`)}>{row.professeur}</td>
                    ...
                    <td className={row.etat}>
                        ...
                        <button className="btn btn-danger">
                            <img src='../assets/admin_edit.svg' onClick={()=>setShowProfEtat(true)}/>
                        </button>
                        <span>{row.etat}</span>
                        </div>
                    </td>
                    <td>
                        <button className="btn btn-primary">
                            <img src='../assets/aye.svg' onClick={()=>Navigate(`/admin/${tab}/edit`)}/>
                        </button>
                        <button className="btn btn-danger">
                            <img src='../assets/admin_delete.svg' onClick={()=>setShowDelete(true)} />
                        </button>
                    </td>
                    </tr>
                ))}
            ...
            <div className='pop_up_container'>
                <div className='pop_up edit etat'>
                    ...
                    <div className='edit_etat'>
                        <label>Etat actuel: <span className='Inscrit'>Inscrit</span></label>
                        <div className='radio_container'> 
                    ...
                    <img className='hide_btn' onClick={()=>setShowProfEtat(false)} src="../assets/x.svg"/>
                </div>                
            </div>
        )
    }         
                ...
                <div className='pop_up edit etat delete'>
                    ...
                    <div className='edit_etat delete'>
                        <p className='delete_text'>
                            ...
                            lélève <span>Nicholas Patrick</span>?
                        </p>
                        <button>Confirmer</button>
                    </div>
                    <img className='hide_btn' onClick={()=>setShowDelete(false)} src="../assets/x.svg"/>
                </div>                
            </div>
        )
    }  
